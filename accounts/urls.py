...
from accounts.views import MyLoginView, SignUpView, Following_DetailView, Follower_DetailView,UserPage_View, Like_postView, Follow, Follow_remove, Like, Like_remove
