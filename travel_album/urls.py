...
from travel_album.views import Diary_listView, Diary_DetailView, Diary_DeleteView, Album_listView, Photo_listView, Diary_CreateView, Album_addView, Album_DeleteView
